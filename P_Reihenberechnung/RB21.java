            ...
            for(int y = 0; y < 24; y++)
            {
                ...
                if( a != b && a < b )
                {
                    for(int z = 0; z < 24; z++)
                    {
                        ...
                        {
                            System.out.println("a(w) = " + a + " , b(w) = " + b + "  --> c(w) = " + wert);
            ...
            for(int y = 0; y < 24; y++)
            {
                ...
                if( a != b && a < b )
                {
                    for(int z = 0; z < 24; z++)
                    {
                        ...
                        {
                            System.out.println("a(w) = " + a + " , b(w) = " + b + "  --> c(s) = " + wert);
            ...
            for(int y = 0; y < 24; y++)
            {
                ...
                if( a != b && a < b )
                {
                    for(int z = 0; z < 24; z++)
                    {
                        ...
                        if(wert == stein.getW(z) && neu == true)
                        {
                            System.out.println("a(w) = " + a + " , b(s) = " + b + "  --> c(w) = " + wert);
            ...
            for(int y = 0; y < 24; y++)
            {
                ...
                if( a != b && a < b )
                {
                    for(int z = 0; z < 24; z++)
                    {
                        ...
                        if(wert == stein.getW(z) && neu == true)
                        {
                            System.out.println("a(s) = " + a + " , b(w) = " + b + "  --> c(w) = " + wert);
            ...
            for(int y = 0; y < 24; y++)
            {
                ...
                if( a != b && a < b )
                {
                    for(int z = 0; z < 24; z++)
                    {
                        ...
                        if(wert == stein.getS(z) && neu == true)
                        {
                            System.out.println("a(s) = " + a + " , b(s) = " + b + "  --> c(s) = " + wert);
            ...
            for(int y = 0; y < 24; y++)
            {
                ...
                if( a != b && a < b )
                {
                    for(int z = 0; z < 24; z++)
                    {
                        ...
                        if(wert == stein.getW(z) && neu == true)
                        {
                            System.out.println("a(s) = " + a + " , b(s) = " + b + "  --> c(w) = " + wert);
            ...
            for(int y = 0; y < 24; y++)
            {
                ...
                if( a != b && a < b )
                {
                    for(int z = 0; z < 24; z++)
                    {
                        ...
                        if(wert == stein.getS(z) && neu == true)
                        {
                            System.out.println("a(s) = " + a + " , b(w) = " + b + "  --> c(s) = " + wert);
            ...
            for(int y = 0; y < 24; y++)
            {
                ...
                if( a != b && a < b )
                {
                    for(int z = 0; z < 24; z++)
                    {
                        ...
                        if(wert == stein.getS(z) && neu == true)
                        {
                            System.out.println("a(w) = " + a + " , b(s) = " + b + "  --> c(s) = " + wert);
